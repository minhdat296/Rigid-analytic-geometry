\section{Classical rigid-analytic spaces}
    ...
    \subsection{Raynaud's formal models for rigid spaces}
        \subsubsection{Coherent sheaves on formal schemes topologically of finite presentations}
            ...
            \begin{proposition}[Comparing definitions \ref{def: admissible_affinoid_algebras} and \ref{def: pre_admissible_and_pre_adic_rings}] \label{prop: tate_algebras_over_valuation_rings_are_topologically_pre_admissible}
            ...
            \end{convention}
            \begin{remark}[Admissibility is fpqc-local and relative]
